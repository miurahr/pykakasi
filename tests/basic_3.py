...
class TestPyKakasi(unittest.TestCase):
    ...
    def test_H2a_kunrei(self):
        ...
        TESTS = [
            ("しつもん",   ("si",1)),
            ("ちがい", ("ti",1)),
            ("きゃ", ("kya", 2)), ("きゅ", ("ky", 2)), ("きょ", ("kyo", 2)),
            ("しゃ", ("sya", 2)), ("しゅ", ("sy", 2)), ("しょ", ("syo", 2)),
            ("ちゃ", ("tya", 2)), ("ちゅ", ("ty", 2)), ("ちょ", ("tyo", 2)),
            ("にゃ", ("nya", 2)), ("にゅ", ("ny", 2)), ("にょ", ("nyo", 2)),
            ("りゃ", ("rya", 2)), ("りゅ", ("ry", 2)), ("りょ", ("ryo", 2)),
            ("ざ", ("za", 1)), ("じ", ("zi", 1)), ("ず", ("z", 1)),
            ("ぜ", ("ze", 1)), ("ぞ", ("zo", 1)),
            ("だ", ("da", 1)), ("ぢ", ("zi", 1)), ("づ", ("z", 1)),
            ("で", ("de", 1)), ("ど", ("do", 1)),
    ...
    def test_K2a_kunrei(self):
        ...
        TESTS = [
            ...
            ("ジー", ("zi", 1)),
            ("ウォークマン", ("", 1)),
            ("キャ", ("kya", 2)), ("キュ", ("ky", 2)), ("キョ", ("kyo", 2)),
            ("シャ", ("sya", 2)), ("シュ", ("sy", 2)), ("ショ", ("syo", 2)),
            ("チャ", ("tya", 2)), ("チュ", ("ty", 2)), ("チョ", ("tyo", 2)),
            ("ニャ", ("nya", 2)), ("ニュ", ("ny", 2)), ("ニョ", ("nyo", 2)),
            ("リャ", ("rya", 2)), ("リュ", ("ry", 2)), ("リョ", ("ryo", 2)),
            ("ザ", ("za", 1)), ("ジ", ("zi", 1)), ("ズ", ("z", 1)),
            ("ゼ", ("ze", 1)), ("ゾ", ("zo", 1)),
            ("ダ", ("da", 1)), ("ヂ", ("zi", 1)), ("ヅ", ("z", 1)),
            ("デ", ("de", 1)), ("ド", ("do", 1)),
